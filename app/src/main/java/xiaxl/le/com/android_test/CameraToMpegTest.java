...
public class CameraToMpegTest extends AndroidTestCase {
    ...
    private void encodeCameraToMpeg() {
        ...
        try {
            ...
            // 准备一个SurfaceTexture，把SurfaceTexture传给Camera
    ...
    private static class CodecInputSurface {
         ...
         * 初始化 mEGLDisplay mEGLContext mEGLSurface
         */
    ...
    private static class STextureRender {
         ...
         * 绘制
         *
         * @param st SurfaceTexture
         */
        public void drawFrame(SurfaceTexture st) {
            checkGlError("onDrawFrame start");
            // 从SurfaceTexture中获取矩阵
